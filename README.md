...
## 💻 System Requirements
Before downloading orientdb-g98, ensure your system meets the following requirements:
...
## 🛠️ Features
orientdb-g98 comes packed with user-friendly features:
- **Intuitive Interface**: Easily navigate through databases and data models.
- **Data Import/Export**: Quickly import data from various formats and export data to your preferred format.
- **Query Management**: Run simple queries to retrieve information quickly and efficiently.
- **Backup Options**: Keep your data safe with backup functionalities.

## 📚 User Guide
For detailed instructions on how to use orientdb-g98:
